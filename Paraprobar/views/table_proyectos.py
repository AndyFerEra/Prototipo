        ...
        rx.table.root(
            rx.table.header(
                ...
                rx.table.row(
                    ...
                    _header_cell("Nombre Pry", "folder-open-dot"),
                    _header_cell("Etp Ing", "brain"),
                    _header_cell("Año", "calendar-range"),
                    _header_cell("Venta(CD)", "badge-dollar-sign"),
                    _header_cell("Cant Entrgbl", "chart-no-axes-column-increasing"),
                    _header_cell("Ratio HH/Entrgbl (venta)", "clock-3"),
                    _header_cell("Ratio USD/Entrgbl (venta)", "dollar-sign"),
                ),
            ),
            rx.table.body( 
                rx.foreach(
